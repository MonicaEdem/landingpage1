...
const products = [
  {
    ...
    description:
      "A delicious and hearty mushroom soup made with organic mushrooms and herbs.",
    image: sliderImage1,
  },
  {
    id: 2,
    name: "⁠Mushbrown ( 500g)",
    description:
      "A savory and chewy mushroom jerky, packed with umami flavors and nutrients.",
    image: sliderImage2,
  },
  {
    id: 3,
    ...
    description:
      "Finely ground mushroom powder, perfect for adding to soups, smoothies, and dishes.",
    image: sliderImage3,
  },
  {
    id: 4,
    ...
    description:
      "Nutrient-rich mushroom powder that boosts immunity and enhances flavor.",
    image: sliderImage1,
  },
];
...
const Products = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative px-8 py-16 lg:px-24 bg-cover bg-center bg-no-repeat"
      id="products"
      style={{
      ...
      <div className="relative z-10">
        ...
        <div className="relative">
          ...
          >
            {products.map((product) => (
              ...
              >
                <motion.div
                  className="bg-white rounded-md shadow-md overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
                  initial="hidden"
                  animate="visible"
                  variants={animationVariants}
                >
          ...
          <motion.button
            className={`custom-prev absolute top-1/2 left-4 z-10 transform -translate-y-1/2 p-2 rounded-full transition-all ${
              isBeginning
                ...
                : "bg-green-500 hover:bg-green-700 opacity-100 cursor-pointer"
            }`}
        ...
        >
          <motion.a
            ...
            className="flex items-center gap-2 px-6 py-3 bg-green-500 text-white rounded-full transition hover:bg-orange-400 hover:text-white"
